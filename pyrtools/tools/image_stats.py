...
def skew2(np_array, mean=None, var=None):
    ...
    if np.isreal(np_array).all():
        ...
        return skew2(np_array.real, mean.real, var.real) + 1j * skew2(np_array.imag, mean.imag,
                                                                      var.imag)
...
def kurt2(np_array, mean=None, var=None):
    ...
    if np.isreal(np_array).all():
        ...
        return kurt2(np_array.real, mean.real, var.real) + 1j * kurt2(np_array.imag, mean.imag,
                                                                      var.imag)
