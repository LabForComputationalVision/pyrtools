...
# these are for the alabaster theme
# html_theme_options = {
...
latex_documents = [
    (master_doc, 'pyrtools.tex', 'pyrtools Documentation',
     'Eero Simoncelli, Rob Young, William Broderick, Pierre-Étienne Fiquet, Zhuo Wang, Zahra Kadkhodaie, Nikhil Parthasarathy', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyrtools', 'pyrtools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyrtools', 'pyrtools Documentation',
     author, 'pyrtools', 'One line description of project.',
     'Miscellaneous'),
]
